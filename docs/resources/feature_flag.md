...
- `deprecated` (Boolean) Specifies whether the flag is deprecated or not. You cannot create a new flag that is deprecated, but you can deprecate an existing flag.
