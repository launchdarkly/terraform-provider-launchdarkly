...
- `integration_key` (String) The integration key. Supported integration keys are `appoptics`, `chronosphere`, `cloudtrail`, `datadog`, `datadog-private`, `dynatrace`, `dynatrace-v2`, `elastic`, `grafana`, `honeycomb`, `jira`, `kosli`, `last9`, `ld-to-git`, `logdna`, `mattermost`, `msteams`, `new-relic`, `new-relic-apm`, `new-relic-apm-insights`, `pagerduty`, `sample-integration`, `signalfx`, `slack`, `splunk`, `terraform-cloud`, and `vercel-native`. A change in this field will force the destruction of the existing resource and the creation of a new one.
