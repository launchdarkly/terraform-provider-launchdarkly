...
- `max_concurrent_requests` (Number) The maximum number of concurrent requests to the LaunchDarkly API (provider-specific --parallelism logic). Defaults to 10. Set this to a lower value if you are hitting timeouts or 429s.
